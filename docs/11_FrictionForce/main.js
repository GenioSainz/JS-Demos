...
let ParticlesArray = [];
let nParticles     = 20;
let particleOptions = {drawPath:true,pathPoints:50, radius:50}
...
function setup() {
  ...
  for(i=0;i<nParticles;i++){
      ...
      //ParticlesArray.push( new Particle({x:windowWidth/2,y:windowHeight/2} ,{v_m:random(6,12),v_d:random(-120,-60)},{a_m:0.0,a_d:90},{r:10}) )
       ...
       ParticlesArray.push( new Particle({x:0,y:windowHeight/2} ,{v_m:random(4,8),v_d:random(-30,-80)},{a_m:0.025,a_d:90},particleOptions) );
